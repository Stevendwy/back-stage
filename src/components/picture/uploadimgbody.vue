...
<style>
.vue-uploader .file-tips {margin: 20px 0; text-align: center;}
/* 图片预览 */
...
.vue-uploader .file-list .file-item .file-remove{font-size: 20px;font-weight: bold;line-height: 16px; position: absolute;top: -10px;right: -10px;width: 20px;height: 20px;transform: rotate(45deg);text-align: center;color: #f00;border: 1px solid #f00;border-radius: 50%;background: transparent; }
/* add */
