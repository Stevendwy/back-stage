<template>
    <div class="event-content">
        ...
        <div class="event-box" :style="{'height':'auto','display':'block'}">
            <ul>
                <li class="event-list" v-for="(value, index) in getToDo" :key="index">
        ...
        <div class="event-box">
            <ul>
                <li class="event-list" v-for="(value, index) in getDone" :key="index">
        ...
        <div class="event-box" :class="{'event-box-hide':false}">
            <ul>
                <li class="event-list" v-for="(value, index) in getCancel" :key="index">
